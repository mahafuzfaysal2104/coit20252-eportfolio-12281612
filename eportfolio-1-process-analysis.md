...
![PDF of Peer-Reviewed Journal Article](Artefact2.png)  
...
![PDF of Conference Papere](Artefact3.png)  
...
![PDF of Master Thesis](Artefact4.png)  
...
**Justification:** This connects to resource allocation analysis, one of the techniques for analysing human interactions in Week 3 (slide 31). It gave me a far more concrete, evidence-based picture of allocation than the lecture alone, showing that real allocation decisions are shaped by informal habits and bias as much as by formal criteria like workload and skill (Anger and Klefbom Ridderstråle, 2025, p. 37).
